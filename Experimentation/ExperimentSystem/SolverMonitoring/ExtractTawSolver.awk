...
BEGIN {
  maxn=0; c=0; mcl=0; l=0; t=0; sat=2; nds=0; bnds=0; r1=0; pls="NA"; apn="NA"; sol="NA"; ptime=0; pn=0; pc=0; taut=0; file=""; opt=""; prog=""; vers=""; wghts=""
}
...
END { 
  print maxn " " c " " l " " mcl " " t " " sat " " nds " " bnds " " r1 " " pls " " apn " " sol " " ptime " " pn " " pc " " taut " \"" file "\"" " \"" opt "\"" " \"" prog "\"" " \"" vers "\""" \"" wghts "\""
}
