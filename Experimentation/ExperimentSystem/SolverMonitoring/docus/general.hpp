// Matthew Gwynne, 29.8.2011 (Swansea)
...
/*!
  ...
  <ul>
   ...
   <li> <code>InputStatistics</code>: statistics on the instance(-file). </li>
...
576 5536 25.4 1 807682 916640 1726 59107785 20.00 0.00 0.00 15525217
  ...
  <ul>
   <li> rn, n : integer, number of variables. </li>
   <li> rc, c : integer, number of clauses. </li>
   <li> rl, l : integer, number of literal occurrences. </li>
