...
#
# Result:
#     The result data.frame has as it's columns, the output parameters
...
eval_ubcsat <- 
function(input, output="$TARGET-$ALG.result", command=eval_ubcsat_command,
  algs=eval_ubcsat_cnf_algs, output_params=eval_ubcsat_output_params, 
  params = eval_ubcsat_std_params,stats_output="$TARGET-$ALG.stats.result",
  monitor=FALSE) {
