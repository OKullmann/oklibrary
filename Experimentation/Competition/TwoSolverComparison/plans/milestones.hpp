// Oliver Kullmann, 28.5.2010 (Swansea)
...
/*!
  ...
  \module_version Competition/TwoSolverComparison 0.0.8 (7.6.2010)
  ...
  \par
   In Competition/TwoSolverComparison/plans/general.hppp the following topics
   are handled:
    - Overview
