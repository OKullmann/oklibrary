...
> VanderWaerden-O3-DNDEBUG k1 k2 n > VanDerWaerden_2-k1-k2_n.cnf
  ...
  <ul>
   ...
   <li> So we consider vanderwaerden_g(t,"pd"), the smallest n such that
   for all n' >= n no palindromic solution w.r.t. t exists. </li>
   <li> This number together with vanderwaerden_g(t,"pdsat"), the largest n
   such that for all n' <= n a palindromic solution w.r.t. t exists, determines
   satisfiabibility of all n (w.r.t. t). </li>
