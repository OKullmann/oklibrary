...
/*!
  ...
  <ul>
   ...
   \verbatim
> k=38 n=1368 expdate="2010-12-14-225335"; export k n expdate; cat AltExp/Exp_PdVanderWaerden_2-3-${k}_gsat-tabu-100-30000000_${expdate}/VanDerWaerden_pd_2-3-${k}_${n}.cnf_sol | PdExtend-O3-DNDEBUG ${n} > solution
