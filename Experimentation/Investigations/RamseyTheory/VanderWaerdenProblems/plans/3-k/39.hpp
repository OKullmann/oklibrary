...
/*!
  ...
  \todo vanderwaerden_2(3,39) > ?
  <ul>
   <li> The very weak current conjecture is vanderwaerden_2(3,39) = ???. </li>
   <li> Starting search with the best palindromic solution:
   \verbatim
> cat AltExp/Exp_PdVanderWaerden_2-3-39_gsat-tabu-???/VanDerWaerden_pd_2-3-39_???.cnf_sol | PdExtend-O3-DNDEBUG ??? > solution

> RunVdW3k 39 ??? rots 100 100000000 solution
   \endverbatim
   </li>
  </ul>
  ...
  <ul>
   <li> ? < vanderwaerden_g([3,39],"pd") =(conj) ? =(conj)
   vanderwaerden([3,39]) - ???. </li>
   <li> vanderwaerden_g([3,39],"pdsat") =(conj) ?. </li>
   <li> Certificates:
    <ol>
     <li> n=?:
     \verbatim
