...
325
  ...
  \todo vdw_2^pd(3,33) >= (996,1005)
  <ul>
   <li> pdvanderwaerden([3,33])[2] =(conj) 1005 =(conj)
   vanderwaerden([3,33]) - 59. </li>
   <li> pdvanderwaerden([3,33])[1] =(conj) 996. </li>
   <li> Certificates:
    <ol>
     <li> n=995:
     \verbatim
...
100 
   ...
   <li> "RunPdVdWk1k2 3 33 gsat-tabu 100 20000000" yields
   \verbatim
Break point 1: 996
Break point 2: 1005
   \endverbatim
   where all solutions were found within in the first 12 runs. </li>
  </ul>
