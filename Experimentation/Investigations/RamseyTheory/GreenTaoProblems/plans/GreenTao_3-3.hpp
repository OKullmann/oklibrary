...
/*!
  ...
  output_greentao_logarithmic_stdname([3,3,3],n) or
  output_greentao_logarithmic_strong_stdname([3,3,3],n).
  ...
  <ul>
   <li> n=137:
    <ol>
     ...
     difference. </li>
     <li> With the logarithmic translation only 1433824 (22 restarts) were
     needed. </li>
    </ol>
   </li>
