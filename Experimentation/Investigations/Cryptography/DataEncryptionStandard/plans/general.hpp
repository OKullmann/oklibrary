...
/*!
  ...
  <ul>
   <li> Using the functions:
    <ul>
     <li> output_des_random_pc_pa_std, </li>
     <li> output_des_random_pk_pa_std, </li>
     <li> output_des_random_kc_pa_std, </li>
     <li> output_des_random_pkc_pa_std </li>
    </ul>
   ...
   \verbatim
XXX what is the meaning of this all ??? XXX
...
maxima> output_des_random_pkc_pa_std(1,5)$
shell> cat des_6t4_canon_r5.cnf | ApplyPass-O3-DNDEBUG des_pkctriple_r5_s1.pa > des_6t4_canon_r5_s1.cnf
shell> (cat des_pkctriple_r5_s1.pa | sed 's/ 0 *\( \|$\)//g';
        OKsolver_2002-O3-DNDEBUG -O des_6t4_canon_r5_s1.cnf | grep "^v" | sed 's/v //g') > des_pkctriple_r5_s1.ta
   \endverbatim
   </li>
