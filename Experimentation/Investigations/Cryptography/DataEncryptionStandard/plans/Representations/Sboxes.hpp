...
/*!
  \file Investigations/Cryptography/DataEncryptionStandard/plans/Representations/Sboxes.hpp
  \brief On investigations into the Data Encryption Standard Sboxes
