...
/*!
  ...
  <ul>
   ...
   identity with that key? See "Keys for which AES encrypts P to P". </li>
  </ul>
  ...
  <ul>
   ...
   scheme (1 row, 1 column, 4-bit field)?
    <ul>
     <li> Using the standard canonical box translation with bidirectional
     MixColumns translation:
      <ul>
...
[10/10] satz215 -v 0.000 403 197 64768 763 1 568 3436 -200 3028 0
   ...
   <li> Do there exist K and P such that AES(P,K,P) for the 16-bit trivial
   AES scheme (2 row, 2 column, 4-bit field)?
    <ul>
     <li> Using the standard canonical box translation with bidirectional
     MixColumns translation:
      <ul>
