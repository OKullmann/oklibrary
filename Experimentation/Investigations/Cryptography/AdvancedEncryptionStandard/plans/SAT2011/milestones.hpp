...
/*!
  \file Experimentation/Investigations/Cryptography/AdvancedEncryptionStandard/plans/SAT2011/milestones.hpp

  \module_version Cryptography/AdvancedEncryptionStandard/KeyDiscovery 0.1.5 (28.7.2011)
  ...
  \par Version history
   ...
   - 0.1.5 : 28.7.2011; initial version number (various AES experiments; prime implicates and minimum CNF data for AES boxes).
