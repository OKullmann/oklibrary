...
/*!
  \file Investigations/Cryptography/AdvancedEncryptionStandard/plans/SAT2011/KeyDiscovery/016/2_2_4/1_1.hpp
  \brief Investigations into small scale AES key discovery for one round AES with a 2x2 block and 4-bit field elements (1+1/3)


  \todo Problem specification
  <ul>
   <li> In this file, we collect the investigations into translations of
   one round small scale AES with two columns and two rows. </li>
   <li> The AES encryption scheme we model takes a 16-bit plaintext,
   16-bit key and applies the following operations:
   <ol>
    <li> Key schedule which takes the key and generates two 16-bit round 
    keys. </li>
   ...
   \verbatim
> print(component_statistics_ss(1,2,2,4,false,aes_mc_bidirectional));
