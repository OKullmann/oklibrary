...
/*!
  \file Investigations/Cryptography/AdvancedEncryptionStandard/plans/SAT2011/KeyDiscovery/016/2_2_4/2_1.hpp
  ...
  <ul>
   ...
   two round small scale AES with two columns and two rows. </li>
   <li> The AES encryption scheme we model takes a 16-bit plaintext,
   16-bit key and applies the following operations:
   <ol>
    <li> Key schedule which takes the key and generates three 16-bit round 
    keys. </li>
