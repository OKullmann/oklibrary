// Matthew Gwynne, 16.11.2011 (Swansea)
  ...
  <ul>
   ...
   of the translations:
    <ul>
     ...
     \verbatim
shell> mkdir ssaes_r1-20_c3_rw1_e4_f0_k1-1_aes_canon_box_aes_mc_bidirectional
shell> cd ssaes_r1-20_c3_rw1_e4_f0_k1-1_aes_canon_box_aes_mc_bidirectional
shell> oklib --maxima
num_rows : 1$
num_columns : 3$
exp : 4$
...
shell> for r in $(seq 1 20); do
  for s in $(seq 1 20) do
    AppendDimacs-O3-DNDEBUG ssaes_r${r}_c3_rw1_e4_f0.cnf ssaes_pcpair_r${r}_c3_rw1_e4_f0_s${s}.cnf > r${r}_k${s}.cnf;
     ...
     \verbatim
shell> mkdir ssaes_r1-20_c3_rw1_e4_f0_k1-1_aes_min_box_aes_mc_bidirectional
shell> cd ssaes_r1-20_c3_rw1_e4_f0_k1-1_aes_min_box_aes_mc_bidirectional
shell> oklib --maxima
num_rows : 1$
num_columns : 3$
exp : 4$
...
shell> for r in $(seq 1 20); do
  for s in $(seq 1 20) do
    AppendDimacs-O3-DNDEBUG ssaes_r${r}_c3_rw1_e4_f0.cnf ssaes_pcpair_r${r}_c3_rw1_e4_f0_s${s}.cnf > r${r}_k${s}.cnf;
     ...
     \verbatim
shell> mkdir ssaes_r1-20_c3_rw1_e4_f0_k1-1_aes_1base_box_aes_mc_bidirectional
shell> cd ssaes_r1-20_c3_rw1_e4_f0_k1-1_aes_1base_box_aes_mc_bidirectional
shell> oklib --maxima
num_rows : 1$
num_columns : 3$
exp : 4$
...
R> E = read.table("AllStatistics", header=TRUE)
R> aggregate(E, by=list(r=E$r), FUN=mean)
 r          t sat     cfs     dec   rts         r1 stime      cfl  r    s
 1 0.00129920   1   12.60   17.50  1.00     274.25 0e+00    47.70  1 10.5
 2 0.00294900   1  151.80  170.00  2.00    5006.40 0e+00  1076.35  2 10.5
 3 0.01164775   1 1037.55 1164.25  6.80   35272.45 0e+00  8485.30  3 10.5
 4 0.02119625   1 1632.30 1817.00  9.80   84047.35 0e+00 16503.75  4 10.5
 5 0.04454275   1 2438.15 2702.40 13.70  209070.45 0e+00 27488.45  5 10.5
 6 0.07833770   1 3571.95 4021.95 18.00  384206.55 0e+00 39985.25  6 10.5
 7 0.10123410   1 4012.95 4555.20 19.30  497897.35 0e+00 44606.40  7 10.5
 8 0.07293845   1 2694.30 3162.85 14.20  346702.25 0e+00 29397.45  8 10.5
 9 0.11693170   1 3838.70 4482.25 19.30  574464.05 0e+00 42421.15  9 10.5
10 0.12957990   1 3968.90 4712.75 20.10  621640.00 0e+00 44220.20 10 10.5
11 0.12578050   1 3695.65 4491.20 19.45  603521.65 0e+00 40933.40 11 10.5
12 0.16132500   1 4493.40 5547.05 22.45  764176.80 0e+00 52200.25 12 10.5
