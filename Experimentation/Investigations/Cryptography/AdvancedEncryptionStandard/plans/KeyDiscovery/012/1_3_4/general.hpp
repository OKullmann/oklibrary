...
setwd("ssaes_r1-20_c3_rw1_e4_f0_k1-20_aes_canon_box_aes_mc_bidirectional")
E_canon = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c3_rw1_e4_f0_k1-20_aes_1base_box_aes_mc_bidirectional")
E_1base = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c3_rw1_e4_f0_k1-20_aes_min_box_aes_mc_bidirectional")
        ...
        <ul>
         ...
         most plausible best fits:
          <ul>
           <li> Canonical:
            <ul>
             <li> t = 0.002884 * r^1.65681, or t = 0.01233 * e^(0.19564*r),</li>
             <li> t = 65.3462 * r^1.3604, or cfs = 289.562 * e^(0.13247*r). </li>
            </ul>
           </li>
           <li> 1-base:
            <ul>
             <li> t = 0.00069643 * r^1.9551, or t = 0.00411 * e^(0.225*r), </li>
             <li> t = 46.9785 * r^1.4932, or cfs = 227.534 * e^(0.15*r). </li>
            </ul>
           </li>
           <li> minimum:
            <ul>
             <li> t = 0.0008245 * r^1.9353, or t = 0.466 * e^(0.22943*r), </li>
             <li> t = 45.629 * r^1.7169, or cfs = 232.17 * e^(0.191*r). </li>
            </ul>
           </li>
          </ul>
         </li>
...
(Intercept) -5.84834    0.12471  -46.90   <2e-16 ***
log(x)       1.65681    0.05518   30.03   <2e-16 ***
Residual standard error: 0.8742 on 398 degrees of freedom
Multiple R-squared: 0.6937,	Adjusted R-squared: 0.693
F-statistic: 901.6 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
             Estimate Std. Error t value Pr(>|t|)
(Intercept) -4.395459   0.114553  -38.37   <2e-16 ***
x            0.195641   0.009563   20.46   <2e-16 ***
Residual standard error: 1.103 on 398 degrees of freedom
Multiple R-squared: 0.5126,	Adjusted R-squared: 0.5114
F-statistic: 418.6 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-5.84834) = 0.002884684
# exp(-4.395459) = 0.01233322


# The polynomial line   t = 0.002884684 * r^1.65681  seems to fit just
# as well as the slowly growing exponential function
# t = 0.01233322 * e^(0.195641*r); there is no significant difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -7.26954    0.17486  -41.57   <2e-16 ***
log(x)       1.95515    0.07737   25.27   <2e-16 ***
Residual standard error: 1.226 on 398 degrees of freedom
Multiple R-squared: 0.6161,	Adjusted R-squared: 0.6151
F-statistic: 638.6 on 1 and 398 DF,  p-value: < 2.2e-16


summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -5.49414    0.15477  -35.50   <2e-16 ***
x            0.22507    0.01292   17.42   <2e-16 ***
Residual standard error: 1.49 on 398 degrees of freedom
Multiple R-squared: 0.4326,	Adjusted R-squared: 0.4312
F-statistic: 303.5 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-7.26954) = 0.0006964323
# exp(-5.49414) = 0.00411079

# The polynomial line   t = 0.0006964323 * r^1.95515 seems to fit just
# as well as the slowly growing exponential function
# t = 0.00411079 * e^(0.22507*r); there is no significant difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -7.10068    0.16188  -43.86   <2e-16 ***
log(x)       1.93530    0.07162   27.02   <2e-16 ***
Residual standard error: 1.135 on 398 degrees of freedom
Multiple R-squared: 0.6472,	Adjusted R-squared: 0.6463
F-statistic: 730.1 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -5.41310    0.14282  -37.90   <2e-16 ***
x            0.22943    0.01192   19.24   <2e-16 ***
Residual standard error: 1.375 on 398 degrees of freedom
Multiple R-squared: 0.482,	Adjusted R-squared: 0.4807
F-statistic: 370.3 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-7.10068) = 0.000824544
# exp(-5.41310) = 0.4660092

# The polynomial line   t = 0.000824544 * r^1.93530  seems to fit just as
# well as the slowly growing exponential function
# t = 0.4660092 * e^(0.22943*r); there is no significant difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)   4.1797     0.1770   23.62   <2e-16 ***
log(x)        1.3604     0.0783   17.38   <2e-16 ***
Residual standard error: 1.24 on 398 degrees of freedom
Multiple R-squared: 0.4313,	Adjusted R-squared: 0.4299
F-statistic: 301.9 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  5.66837    0.15122   37.48   <2e-16 ***
x            0.13247    0.01262   10.49   <2e-16 ***
Residual standard error: 1.456 on 398 degrees of freedom
Multiple R-squared: 0.2167,	Adjusted R-squared: 0.2148
F-statistic: 110.1 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(4.1797) = 65.34625
# exp(5.66837) = 289.5622

# The polynomial line   cfs = 65.34625 * r^1.3604 seems to fit
# just as well as the slowly growing exponential function
# cfs = 289.5622 * e^(0.13247*r); there is not a significant
# difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  3.84969    0.17937   21.46   <2e-16 ***
log(x)       1.49328    0.07936   18.82   <2e-16 ***
Residual standard error: 1.257 on 398 degrees of freedom
Multiple R-squared: 0.4708,	Adjusted R-squared: 0.4694
F-statistic:   354 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  5.42730    0.15502   35.01   <2e-16 ***
x            0.15079    0.01294   11.65   <2e-16 ***
Residual standard error: 1.492 on 398 degrees of freedom
Multiple R-squared: 0.2544,	Adjusted R-squared: 0.2525
F-statistic: 135.8 on 1 and 398 DF,  p-value: < 2.2e-16


# exp(3.84969) = 46.9785
# exp(5.42730) = 227.5341

# The polynomial line   cfs = 46.9785 * r^1.49328 and
# the slowly growing exponential function
# cfs = 227.5341 * e^(0.15079*r) seem to fit equally well.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  3.82055    0.14772   25.86   <2e-16 ***
log(x)       1.71699    0.06536   26.27   <2e-16 ***
Residual standard error: 1.035 on 398 degrees of freedom
Multiple R-squared: 0.6342,	Adjusted R-squared: 0.6333
F-statistic: 690.1 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  5.44750    0.13582   40.11   <2e-16 ***
x            0.19119    0.01134   16.86   <2e-16 ***
Residual standard error: 1.308 on 398 degrees of freedom
Multiple R-squared: 0.4167,	Adjusted R-squared: 0.4153
F-statistic: 284.4 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(3.82055) = 45.6293
# exp(5.44750) = 232.177

# The polynomial line   cfs = 45.6293 * r^1.71699 and
# the slowly growing exponential function
# cfs = 232.177 * e^(0.19119*r) seem to fit equally well.
         \endverbatim
         </li>
        </ul>
       </li>
