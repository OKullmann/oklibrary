...
/*!
  \file Investigations/Cryptography/AdvancedEncryptionStandard/plans/SAT2011/KeyDiscovery/064/4_4_4/general.hpp
  \brief Investigations into small-scale AES key discovery for AES with a 4x4 plaintext matrix and 4-bit field elements


  \todo Problem specification
  <ul>
  <li> We consider the small-scale AES with 4 row, 4 column, using the 4-bit
   field size for rounds 1 to 20. </li>
   <li> We denote this AES instance by aes(r,4,4,4) for r in 1,...,20. </li>
   <li> We investigate translations of the key discovery problem for
   aes(r,4,4,4) into SAT. </li>
   <li> aes(r,4,4,4) takes a 64-bit plaintext and 64-bit key and outputs a
   64-bit ciphertext. </li>
   <li> aes(r,4,4,4) applies the following operations:
    <ol>
