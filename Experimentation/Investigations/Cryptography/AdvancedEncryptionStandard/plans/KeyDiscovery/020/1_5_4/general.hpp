...
setwd("ssaes_r1-20_c5_rw1_e4_f0_k1-20_aes_canon_box_aes_mc_bidirectional")
E_canon = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c5_rw1_e4_f0_k1-20_aes_1base_box_aes_mc_bidirectional")
E_1base = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c5_rw1_e4_f0_k1-20_aes_min_box_aes_mc_bidirectional")
        ...
        <li> For all translations, the hypothesis that there is a polynomial
         ...
         most plausible best fits:
          <ul>
           <li> Canonical:
            <ul>
             <li> t = 0.001837 * r^4.31393, or t = 0.06918 * e^(0.5241*r), </li>
             <li> cfs = 37.326 * r^3.892, or cfs = 1459.18 * e^(0.4356*r). </li>
            </ul>
           </li>
           <li> 1-base:
            <ul>
             <li> t = 0.0002017 * r^4.8455, or t = 0.01481 * e^(0.5676*r), </li>
             <li> cfs = 37.326 * r^3.8928, or cfs = 1459.18 * e^(0.435*r). </li>
            </ul>
           </li>
           <li> minimum:
            <ul>
             <li> t = 0.000216 * r^4.7978, or t = 0.466 * e^(0.64746*r), </li>
             <li> t = 81.671 * r^3.5364, or cfs = 2234.58 * e^(0.397*r). </li>
            </ul>
           </li>
          </ul>
         </li>
         <li> Note that the constant multiplications by r for the
         minimum translation are somewhat lower than for the 1-soft
         translations. </li>
         <li> That is the models are (slightly) slower growing exponential
         functions. </li>
         ...
         <li> Perhaps the minimum translations for the 4-bit boxes are better?
         </li>
...
(Intercept) -6.29952    0.22105  -28.50   <2e-16 ***
log(x)       4.31393    0.09781   44.11   <2e-16 ***
Residual standard error: 1.55 on 398 degrees of freedom
Multiple R-squared: 0.8302,	Adjusted R-squared: 0.8297
F-statistic:  1945 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -2.67090    0.23129  -11.55   <2e-16 ***
x            0.52410    0.01931   27.14   <2e-16 ***
Residual standard error: 2.227 on 398 degrees of freedom
Multiple R-squared: 0.6493,	Adjusted R-squared: 0.6484
F-statistic: 736.8 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-6.29952) = 0.001837186
# exp(-2.67090) = 0.06918993


# The polynomial line   t = 0.001837186 * r^4.31393   seems to fit just
# as well as the slowly growing exponential function
# t = 0.06918993 * e^(0.52410*r); there is no significant difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  -8.5085     0.2733  -31.14   <2e-16 ***
log(x)        4.8455     0.1209   40.08   <2e-16 ***
Residual standard error: 1.916 on 398 degrees of freedom
Multiple R-squared: 0.8014,	Adjusted R-squared: 0.8009
F-statistic:  1606 on 1 and 398 DF,  p-value: < 2.2e-16


summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -4.21178    0.28839  -14.60   <2e-16 ***
x            0.56762    0.02407   23.58   <2e-16 ***
Residual standard error: 2.776 on 398 degrees of freedom
Multiple R-squared: 0.5828,	Adjusted R-squared: 0.5817
F-statistic: 555.9 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-8.5085) = 0.0002017462
# exp(-4.21178) = 0.01481997

# The polynomial line   t = 0.0002017462 * r^4.8455 seems to fit just
# as well as the slowly growing exponential function
# t = 0.01481997 * e^(0.56762*r); there is no significant difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  -8.4401     0.2623  -32.17   <2e-16 ***
log(x)        4.7978     0.1161   41.33   <2e-16 ***
Residual standard error: 1.839 on 398 degrees of freedom
Multiple R-squared: 0.8111,	Adjusted R-squared: 0.8106
F-statistic:  1708 on 1 and 398 DF,  p-value: < 2.2e-16
...
# exp(-8.4401) = 0.0002160285
# exp(-0.76355) = 0.4660092

# The polynomial line   t = 0.0002160285 * r^4.7978  seems to fit well,
# slightly better than the slowly growing exponential function
# t = 0.4660092 * e^(0.64746*r) but there is no significant difference.
...
Coefficients:
            Estimate Std. Error t value Pr(>|t|)
(Intercept)   3.6197     0.2492   14.52   <2e-16 ***
log(x)        3.8928     0.1103   35.30   <2e-16 ***
Residual standard error: 1.747 on 398 degrees of freedom
Multiple R-squared: 0.7579,	Adjusted R-squared: 0.7573
F-statistic:  1246 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
Coefficients:
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  7.28563    0.26003   28.02   <2e-16 ***
x            0.43565    0.02171   20.07   <2e-16 ***
Residual standard error: 2.503 on 398 degrees of freedom
Multiple R-squared: 0.503,	Adjusted R-squared: 0.5017
F-statistic: 402.8 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(3.6197) = 37.32637
# exp(7.28563) = 1459.18

# The polynomial line   cfs = 37.32637 * r^3.8928 seems
# just as well as the slowly growing exponential function
# cfs = 1459.18 * e^(0.43565*r); there is not a significant
# difference.
...
# The polynomial line   cfs = 37.32637 * r^3.8928 and
# the slowly growing exponential function
# cfs = 1459.18 * e^(0.43565*r) seem to fit equally well.
...
summary(m_poly
            Estimate Std. Error t value Pr(>|t|)
(Intercept)   4.4027     0.2351   18.73   <2e-16 ***
log(x)        3.5364     0.1040   34.00   <2e-16 ***
Residual standard error: 1.648 on 398 degrees of freedom
Multiple R-squared: 0.7439,	Adjusted R-squared: 0.7432
F-statistic:  1156 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  7.71181    0.23947   32.20   <2e-16 ***
x            0.39777    0.01999   19.90   <2e-16 ***
Residual standard error: 2.305 on 398 degrees of freedom
Multiple R-squared: 0.4987,	Adjusted R-squared: 0.4974
F-statistic: 395.9 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(4.4027) = 81.67108
# exp(7.71181) = 2234.583

# The polynomial line   t = 81.67108 * r^3.5364 and
# the slowly growing exponential function
# cfs = 2234.583 * e^(0.39777*r) seem to fit equally well.
         \endverbatim
         </li>
        </ul>
       </li>
