    ...
    <ul>
     <li> minisat-2.2.0:
      <ul>
       ...
       <li> Time: the 1-base and minimum translation outperform the canonical
       translation, by a factor of 2 in some cases. Neither the 1-base or
       minimum translation outperforms the other by any large degree. </li>
       <li> Conflicts: there is no clear best performer in terms of
       the number of conflicts. </li>
