       ...
       <li> Fitting the data:
        <ul>
         ...
         (averaging values for each round over 20 random keys):
          <ul>
           <li> Time taken vs rounds: quadratic model for all translations.
           <li> Conflicts vs rounds: quadratic model for all translations. </li>
          </ul>
         </li>
