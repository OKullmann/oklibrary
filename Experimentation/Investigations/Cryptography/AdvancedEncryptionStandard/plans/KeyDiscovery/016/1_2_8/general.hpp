       ...
       <li> Fitting the data:
        <ul>
         ...
         (averaging values for each round over 20 random keys):
          <ul>
           <li> Time taken vs rounds:
            <ul>
             <li> quadratic model for all 1-soft translations; </li>
             <li> exponential model for the minimum translation. </li>
            </ul>
           </li>
           <li> Conflicts vs rounds:
            <ul>
             <li> constant model for the canonical translation; </li>
             <li> linear model for the 1-base translation; </li>
             <li> quadratic model for the minimum translation. </li>
            </ul>
           </li>
          </ul>
         </li>
