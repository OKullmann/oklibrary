...
setwd("ssaes_r1-20_c2_rw1_e8_f0_k1-20_aes_canon_box_aes_mc_bidirectional")
E_canon = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c2_rw1_e8_f0_k1-20_aes_1base_box_aes_mc_bidirectional")
E_1base = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c2_rw1_e8_f0_k1-20_aes_min_box_aes_mc_bidirectional")
...
[1] 1035.704
       ...
       <li> Fitting the data:
        <ul>
         ...
         it is equally likely that there is a slowly growing exponential
         relationship (see below). </li>
         ...
         most plausible best fits:
          <ul>
           <li> Canonical:
            <ul>
             <li> t = 0.5666576 * r^1.443, or t = 2.283068 * e^(0.15819*r), </li>
             <li> t = 5613.165 * r^0.60744, or cfs = 13178.87 * e^(0.04117*r) </li>
            </ul>
           </li>
           <li> 1-base:
            <ul>
             <li> t = 0.5793665 * r^1.93994, or t = 2.75925 * e^(0.242442*r), </li>
             <li> t = 962.3806 * r^1.56663, or cfs = 4213.715 * e^(0.17519*r) </li>
            </ul>
           </li>
           <li> minimum:
            <ul>
             <li> 0.01994653 * r^4.5554, or t = 95.1448 * e^(0.64746*r) , </li>
             <li> t = 2149.649 * r^4.06841, or cfs = 40257.03 * e^(0.56538*r) </li>
            </ul>
           </li>
          </ul>
         </li>
         <li> Note that the constant multiplications by r for the
         minimum translation are much higher than for the 1-soft translations.
         </li>
         <li> That is the models are faster growing exponential functions. </li>
         <li> This likely relates to fewer decisions being made for the 1-soft
         translations. The solver is branching on a smaller fraction of the
...
(Intercept)  -0.5680     0.1912   -2.97  0.00315 **
log(x)        1.4430     0.0846   17.06  < 2e-16 ***
Residual standard error: 1.34 on 398 degrees of freedom
Multiple R-squared: 0.4223,	Adjusted R-squared: 0.4208
F-statistic: 290.9 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  0.82552    0.15661   5.271 2.23e-07 ***
x            0.15819    0.01307  12.100  < 2e-16 ***
Residual standard error: 1.508 on 398 degrees of freedom
Multiple R-squared: 0.2689,	Adjusted R-squared: 0.2671
F-statistic: 146.4 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-0.5680) = 0.5666576
# exp(0.82552) = 2.283068


# The polynomial line   t = 0.5666576 * r^1.443   seems to fit well,
# although a slowly growing exponential function
# t = 2.283068 * e^(0.15819*r)   fits slightly better.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -0.54582    0.11387  -4.793 2.32e-06 ***
log(x)       1.93994    0.05038  38.505  < 2e-16 ***
Residual standard error: 0.7982 on 398 degrees of freedom
Multiple R-squared: 0.7884,	Adjusted R-squared: 0.7878
F-statistic:  1483 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) 1.014959   0.106244   9.553   <2e-16 ***
x           0.242442   0.008869  27.336   <2e-16 ***
Residual standard error: 1.023 on 398 degrees of freedom
Multiple R-squared: 0.6525,	Adjusted R-squared: 0.6516
F-statistic: 747.2 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-0.54582) = 0.5793665
# exp(1.014959) = 2.75925

# The polynomial line   t = 0.5793665 * r^1.93994   seems to fit well,
# although a slowly growing exponential function
# t = 2.75925 * e^(0.242442*r)   fits slightly better.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  -3.9147     0.2980  -13.14   <2e-16 ***
log(x)        4.5554     0.1408   32.36   <2e-16 ***
Residual standard error: 2.004 on 338 degrees of freedom
Multiple R-squared: 0.7559,	Adjusted R-squared: 0.7552
F-statistic:  1047 on 1 and 338 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -0.76355    0.28556  -2.674  0.00786 **
x            0.64746    0.02787  23.233  < 2e-16 ***
Residual standard error: 2.517 on 338 degrees of freedom
Multiple R-squared: 0.6149,	Adjusted R-squared: 0.6138
F-statistic: 539.8 on 1 and 338 DF,  p-value: < 2.2e-16

# exp(-3.9147) = 0.01994653
# exp(4.5554) = 95.1448

# The polynomial line   t = 0.01994653 * r^4.5554  seems to fit well,
# although a slowly growing exponential function
# t = 95.1448 * e^(0.64746*r)   fits slightly better.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  8.63287    0.20075  43.002  < 2e-16 ***
log(x)       0.60744    0.08882   6.839 3.02e-11 ***
Residual standard error: 1.407 on 398 degrees of freedom
Multiple R-squared: 0.1052,	Adjusted R-squared: 0.1029
F-statistic: 46.77 on 1 and 398 DF,  p-value: 3.021e-11

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  9.48637    0.15253  62.194  < 2e-16 ***
x            0.04117    0.01273   3.234  0.00132 **
Residual standard error: 1.468 on 398 degrees of freedom
Multiple R-squared: 0.0256,	Adjusted R-squared: 0.02315
F-statistic: 10.46 on 1 and 398 DF,  p-value: 0.001324

# exp(6.86941) = 5613.165
# exp(9.48637) = 13178.87

# The polynomial line   cfs = 5613.165 * r^0.60744 seems
# to fit better than the slowly growing exponential function
# cfs = 13178.87 * e^(0.04117*r) but there is not a significant
# difference.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  6.86941    0.14207   48.35   <2e-16 ***
log(x)       1.56663    0.06286   24.92   <2e-16 ***
Residual standard error: 0.9959 on 398 degrees of freedom
Multiple R-squared: 0.6095,	Adjusted R-squared: 0.6085
F-statistic: 621.1 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  8.34610    0.12781   65.30   <2e-16 ***
x            0.17519    0.01067   16.42   <2e-16 ***
Residual standard error: 1.23 on 398 degrees of freedom
Multiple R-squared: 0.4039,	Adjusted R-squared: 0.4024
F-statistic: 269.6 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(6.86941) = 962.3806
# exp(8.34610) = 4213.715

# The polynomial line   cfs = 962.3806 * r^1.56663 and
# the slowly growing exponential function
# cfs = 4213.715 * e^(0.17519*r) seem to fit equally well.
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  7.67306    0.18320   41.88   <2e-16 ***
log(x)       4.06841    0.08655   47.01   <2e-16 ***
Residual standard error: 1.232 on 338 degrees of freedom
Multiple R-squared: 0.8673,	Adjusted R-squared: 0.8669
F-statistic:  2210 on 1 and 338 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) 10.60304    0.21890   48.44   <2e-16 ***
x            0.56538    0.02136   26.47   <2e-16 ***
Residual standard error: 1.93 on 338 degrees of freedom
Multiple R-squared: 0.6745,	Adjusted R-squared: 0.6735
F-statistic: 700.4 on 1 and 338 DF,  p-value: < 2.2e-16

# exp(7.67306) = 2149.649
# exp(10.60304) = 4213.715

# The polynomial line   cfs = 2149.649 * r^4.06841 and
# the slowly growing exponential function
# cfs = 40257.03 * e^(0.56538*r) seem to fit equally well.
         \endverbatim
         </li>
        </ul>
       </li>
