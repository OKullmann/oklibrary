    ...
    <ul>
     <li> minisat-2.2.0:
      <ul>
       ...
       \verbatim
# From directory with experiment directories for each translation in.
# Read data tables and compute averages
setwd("ssaes_r1-20_c4_rw1_e4_f0_k1-20_aes_canon_box_aes_mc_bidirectional")
E_canon = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c4_rw1_e4_f0_k1-20_aes_1base_box_aes_mc_bidirectional")
E_1base = read.table("MinisatStatistics",header=TRUE)
setwd("../ssaes_r1-20_c4_rw1_e4_f0_k1-20_aes_min_box_aes_mc_bidirectional")
E_min = read.table("MinisatStatistics",header=TRUE)
       \endverbatim
       </li>
       <li> Overall:
        <ul>
        ...
        <li> For all translations, the hypothesis that there is a polynomial
         ...
         most plausible best fits:
          <ul>
           <li> Canonical:
            <ul>
             <li> t = 0.002884 * r^2.80429, or t = 0.01233 * e^(0.1956*r), </li>
             <li> cfs = 76.84 * r^2.401, or cfs = 289.5622 * e^(0.1324*r). </li>
            </ul>
           </li>
           <li> 1-base:
            <ul>
             <li> t = 0.001207 * r^2.85606, or t = 0.00411 * e^(0.225*r), </li>
             <li> cfs = 78.296 * r^2.36, or cfs = 227.534 * e^(0.1508*r). </li>
            </ul>
           </li>
           <li> minimum:
            <ul>
             <li> t = 0.000982 * r^2.95407, or t = 0.466 * e^(0.22943*r), </li>
             <li> cfs = 88.042 * r^2.397, or cfs = 232.177 * e^(0.191*r). </li>
            </ul>
           </li>
          </ul>
         </li>
         <li> Note that the constant multiplications by r for the
         minimum translation are slightly bigger than for the 1-soft
         translations. </li>
         <li> That is, the models are (slightly) faster growing exponential
         functions. </li>
         <li> This likely relates to more decisions being made for the 1-soft
         translations. The solver is branching on a larger fraction of the
         variables introduced in each round. </li>
         <li> We should run these experiments for 40 rounds or more to try to
         "confirm" these models. </li>
...
(Intercept) -5.78287    0.18212  -31.75   <2e-16 ***
log(x)       2.80429    0.08058   34.80   <2e-16 ***
Residual standard error: 1.277 on 398 degrees of freedom
Multiple R-squared: 0.7527,	Adjusted R-squared: 0.752
F-statistic:  1211 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -3.32698    0.17744  -18.75   <2e-16 ***
x            0.33144    0.01481   22.38   <2e-16 ***
Residual standard error: 1.708 on 398 degrees of freedom
Multiple R-squared: 0.5571,	Adjusted R-squared: 0.556
F-statistic: 500.7 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-5.78287) = 0.002884684
# exp(-3.32698) = 0.01233322

# The polynomial line   t = 0.002884684 * r^2.80429  seems to fit just
# as well as the slowly growing exponential function
# t = 0.01233322 * e^(0.33144*r); there is no significant difference.


########## Time taken vs rounds (1-base) ###########
x = E_1base$r;
y = E_1base$t + 0.000001;
m_poly = lm(log(y) ~ log(x))
m_exp = lm(log(y) ~ x)
plot(x,y)
lines(x, exp(predict(m_exp)), col="red")
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -6.71928    0.21970  -30.58   <2e-16 ***
log(x)       2.85606    0.09721   29.38   <2e-16 ***
Residual standard error: 1.54 on 398 degrees of freedom
Multiple R-squared: 0.6844,	Adjusted R-squared: 0.6837
F-statistic: 863.3 on 1 and 398 DF,  p-value: < 2.2e-16


summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -4.15543    0.20358  -20.41   <2e-16 ***
x            0.33160    0.01699   19.51   <2e-16 ***
Residual standard error: 1.96 on 398 degrees of freedom
Multiple R-squared: 0.4889,	Adjusted R-squared: 0.4876
F-statistic: 380.7 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(-6.71928) = 0.001207407
# exp(-4.15543) = 0.01567905

# The polynomial line   t = 0.001207407 * r^2.85606 seems to fit just
# as well as the slowly growing exponential function
# t = 0.01567905 * e^(0.33160*r); there is no significant difference.


########## Time taken vs rounds (min) ###########
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -6.92590    0.22527  -30.75   <2e-16 ***
log(x)       2.95407    0.09971   29.62   <2e-16 ***
Residual standard error: 1.579 on 397 degrees of freedom
Multiple R-squared: 0.6885,	Adjusted R-squared: 0.6878
F-statistic: 877.7 on 1 and 397 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept) -4.25604    0.21053  -20.22   <2e-16 ***
x            0.34118    0.01758   19.40   <2e-16 ***
Residual standard error: 2.027 on 397 degrees of freedom
Multiple R-squared: 0.4868,	Adjusted R-squared: 0.4855
F-statistic: 376.5 on 1 and 397 DF,  p-value: < 2.2e-16

# exp(-6.92590) = 0.000982019
# exp(-4.25604) = 0.01417834

# The polynomial line   t = 0.000982019 * r^2.95407  seems to fit just as
# well as the slowly growing exponential function
# t = 0.01417834 * e^(0.34118*r); there is no significant difference.


########## Conflicts vs rounds (canonical) ###########
x = E_canon$r;
y = E_canon$cfs + 1;
m_poly = lm(log(y) ~ log(x))
m_exp = lm(log(y) ~ x)
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  4.34175    0.20713   20.96   <2e-16 ***
log(x)       2.40173    0.09164   26.21   <2e-16 ***
Residual standard error: 1.452 on 398 degrees of freedom
Multiple R-squared: 0.6331,	Adjusted R-squared: 0.6322
F-statistic: 686.8 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  6.75459    0.19662   34.35   <2e-16 ***
x            0.25439    0.01641   15.50   <2e-16 ***
Residual standard error: 1.893 on 398 degrees of freedom
Multiple R-squared: 0.3764,	Adjusted R-squared: 0.3748
F-statistic: 240.2 on 1 and 398 DF,  p-value: < 2.2e-16

# exp(4.34175) = 76.8419
# exp(6.75459) = 857.9879

# The polynomial line   cfs = 76.8419 * r^2.40173 seems to fit
# just as well as the slowly growing exponential function
# cfs = 857.9879 * e^(0.25439*r); there is not a significant
# difference.

########## Conflicts vs rounds (1-base) ###########
x = E_1base$r;
y = E_1base$cfs + 1;
m_poly = lm(log(y) ~ log(x))
m_exp = lm(log(y) ~ x)
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)   4.3605     0.2277   19.15   <2e-16 ***
log(x)        2.3607     0.1007   23.44   <2e-16 ***
Residual standard error: 1.596 on 398 degrees of freedom
Multiple R-squared: 0.5798,	Adjusted R-squared: 0.5788
F-statistic: 549.2 on 1 and 398 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  6.77225    0.20866   32.46   <2e-16 ***
x            0.24623    0.01742   14.14   <2e-16 ***
Residual standard error: 2.009 on 398 degrees of freedom
Multiple R-squared: 0.3343,	Adjusted R-squared: 0.3326
F-statistic: 199.8 on 1 and 398 DF,  p-value: < 2.2e-16


# exp(4.3605) = 78.29627
# exp(6.77225) = 873.2746

# The polynomial line   cfs = 78.29627 * r^2.3607 and
# the slowly growing exponential function
# cfs = 873.2746 * e^(0.24623*r) seem to fit equally well.

########## Conflicts vs rounds (min) ###########
x = E_min$r;
y = E_min$cfs +1; # +1 to avoid issues with log(0)
m_poly = lm(log(y) ~ log(x))
m_exp = lm(log(y) ~ x)
plot(x,y)
lines(x, exp(predict(m_exp)), col="red")
...
summary(m_poly)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  4.47782    0.21751   20.59   <2e-16 ***
log(x)       2.39755    0.09628   24.90   <2e-16 ***
Residual standard error: 1.524 on 397 degrees of freedom
Multiple R-squared: 0.6097,	Adjusted R-squared: 0.6087
F-statistic: 620.1 on 1 and 397 DF,  p-value: < 2.2e-16

summary(m_exp)
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  6.88090    0.20217   34.03   <2e-16 ***
x            0.25439    0.01688   15.07   <2e-16 ***
Residual standard error: 1.946 on 397 degrees of freedom
Multiple R-squared: 0.3638,	Adjusted R-squared: 0.3622
F-statistic:   227 on 1 and 397 DF,  p-value: < 2.2e-16

# exp(4.47782) = 88.04253
# exp(6.88090) = 973.5021

# The polynomial line   cfs = 88.04253 * r^2.39755 and
# the slowly growing exponential function
# cfs = 973.5021 * e^(0.25439*r) seem to fit equally well.
         \endverbatim
         </li>
        </ul>
       </li>
