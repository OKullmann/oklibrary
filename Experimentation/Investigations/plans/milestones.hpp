...
/*!
  ...
  \module_version Experimentation/Investigations 0.3.1 (7.3.2012)
  ...
  \par Version history
   ...
   - 0.3.1 : 7.3.2012; started investigations on Cube and Conquer and furthered investigations into Cryptography (AES, DES and now KeeLoq), minimal unsatisfiability, Ramsey theory (new bounds for van der Waerden numbers and their palindromic versions) and (tree-)resolution complexity (pigeon-hole formulas and their extensions).
