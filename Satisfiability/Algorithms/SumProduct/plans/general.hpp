...
/*!
  \file Satisfiability/Algorithms/SumProduct/plans/general.hpp
...
/*!
  \namespace OKlib::SumProduct
  \brief Components for sum-product (or belief-propagation) algorithms
*/
