  ...
  */
  class UniformRange {
    ...
    /* The numbers 0,...,randgen_max generated by g() are partioned into
       maximum consecutive equal-sized intervals ("regions") for outcomes
         s, s+1, ..., s+n-1.
       E.g. for randgen_max = 15, n=3, s=0: size_region = 5, last_regions = 14.
       So 0,...,4 -> 0; 5,...,9 -> 1; 10,...,14 -> 2.
  ...
  */
  public :
    UniformRange(randgen_t& g, const gen_uint_t n, const gen_uint_t start=0)
      ...
      assert(trivial or size_region >= 1);
