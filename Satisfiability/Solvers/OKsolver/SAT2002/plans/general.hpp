...
/* Copyright 2007, 2008, 2009, 2010, 2011, 2023, 2024 Oliver Kullmann
...
/*!
  ...
  \todo BUG with standard input
LatinSquares> N=23; ./CPandiagonal $N "" | OKsolver2002 -O cin
Segmentation fault (core dumped)
Ebenfalls
LatinSquares> N=23; ./CPandiagonal $N "" | OKsolver2002_NTP -O -MAXN=529 -MAXK=280417 cin
Segmentation fault (core dumped)
Saving in a file and then processing works.
