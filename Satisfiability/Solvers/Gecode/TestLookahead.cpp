...
int main(const int argc, const char* const argv[]) {
  ...
  {const option_t options = {BrTpO::mind, BrSrcO::eq, BrSltnO::all, BrEgrO::eager, BrPrnO::pruning};
  ...
  {const option_t options = {BrTpO::mind, BrSrcO::eq, BrSltnO::all, BrEgrO::eager, BrPrnO::pruning};
   ...
   const option_t options2 = {BrTpO::mind, BrSrcO::val, BrSltnO::all, BrEgrO::eager, BrPrnO::pruning};
   ...
   const option_t options3 = {BrTpO::la, BrSrcO::val, BrSltnO::all, BrEgrO::eager, BrPrnO::pruning};
