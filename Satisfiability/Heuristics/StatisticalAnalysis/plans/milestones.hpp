...
/*!
  \file Heuristics/StatisticalAnalysis/plans/milestones.hpp
  
  \module_version Heuristics/StatisticalAnalysis 0.0.4 (8.7.2007)
  ...
  \par Version history
   ...
   - 0.0.4 : 8.7.2007; initial version number (several interesting plans).
