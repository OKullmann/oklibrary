// Oliver Kullmann, 25.3.2010 (Swansea)
...
/*!
  \file Reductions/KLevelForcedAssignments/plans/GeneralisedUCP.hpp
  \brief Plans regarding the components for r_k-reductions
