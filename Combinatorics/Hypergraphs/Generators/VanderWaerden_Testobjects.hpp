...
#include <OKlib/Combinatorics/Hypergraphs/Generators/plans/VanderWaerden_Tests.hpp>

namespace OKlib {
  namespace Van_der_Waerden_hypergraph {
    namespace Testobjects {

      Test_Iterator_arithmetic_progression_Integer<Iterator_arithmetic_progression> test_iterator_arithmetic_progression;

      Test_Arithmetic_progression_Integer<Arithmetic_progression> test_arithmetic_progression;
