...
/*!
  ...
  <ul>
   ...
   <li> Sizes of hyperedges:
    <ol>
     ...
     <li> And always for an hyperedge we should be able to ask for its size. Most
     often stored and updated. </li>
     <li> For every size the number of hyperedges of this size is also often useful. </li>
    </ol>
   </li>
  ...
  \todo Concept design
  <ul>
   <li> Writing the basic concepts for hypergraphs, similar to the concepts for graphs
   from the Boost graph library (sequences of vertices and hyperedges, where hyperedges
   are sequences of vertices). </li>
   <li> The direct access from vertices to incident edges
   ...
   regarding either the vertices or the hyperedges as "left part". </li>
   <li> Clarify the relations to module Graphs (see Graphs/plans/Graphs.hpp). </li>
