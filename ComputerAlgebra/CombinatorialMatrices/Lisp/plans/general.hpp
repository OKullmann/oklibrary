  ...
  <ul>
   ...
   <li> A combinatorial matrix is "complete" if no entry is zero.
    <ol>
     ...
     <li> Perhaps "1-complete" is all entries are 1 ? </li>
     <li> Perhaps we call a matrix "constant", "1-constant" etc. </li>
     <li> Then 1-complete com's would be complete 1-constant com's. </li>
    </ol>
   </li>
   ...
   matrix as a sum of 1-complete submatrices:
    <ol>
     <li> Since rows are columns have names, such a sum has a natural
     meaning. </li>
