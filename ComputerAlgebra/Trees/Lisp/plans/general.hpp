...
/*!
  ...
  <ul>
   ...
   Rheingold-Tilford algorithm should be implemented.
    <ol>
     <li> See Visualisation/GraphDrawing/plans/Trees.hpp. </li>
     <li> Actually implementing the visualisation of trees (where the nodes
     and edges are labelled with real numbers) at the Maxima/Lisp level,
     using Gnuplot, would be interesting. </li>
    </ol>
   </li>
  </ul>
