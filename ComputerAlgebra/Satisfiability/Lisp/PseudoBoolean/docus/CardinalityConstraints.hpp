...
W : {1,2,3,4,5}$
n : 2$ m : 4$
F : cardinality_cs(listify(W),n,m)$
   \endverbatim
   </li>
  ...
  <ul>
   ...
   ucp_lpa_0_cs(apply_pa({1},standardise_fcs(cs_to_fcs(F))[1][2]));
   [{},[{-4,3},{-2}]]
   ucp_lpa_0_cs(apply_pa({2},standardise_fcs(cs_to_fcs(F))[1][2]));
   [{},[{-4,3},{-1}]]
   \endverbatim
   etc. Notice how, providing the constraint "1 + 2" = 1, and then setting
   either 1 or 2 to 1, immediately enforces that variable 2 or 1 (resp.) must
   be false by UCP. </li> 
...
ucp_lpa_0_cs(apply_pa({1},F));
[{{-4,2},{-2,4}},[{3}]]
ucp_lpa_0_cs(apply_pa({2},F));
[{{-4,1},{-1,4}},[{3}]]
ucp_lpa_0_cs(apply_pa({4},F));
[{},[{1,2},{3}]]
   \endverbatim
   </li>
