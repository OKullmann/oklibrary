// Oliver Kullmann, 30.1.2008 (Swansea)
...
/*!
  \file ComputerAlgebra/LinearAlgebra/Lisp/docus/general.hpp
  \brief User documentation for linear algebra (SAT-related in a wider sense) in Lisp/Maxima
