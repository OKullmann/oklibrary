...
/*!
  ...
  <ul>
   ...
   YES: ExternalSources/R/R-2.5.0/doc/html/index.html. </li>
   <li> So the build shall also move the doc/subdirectory. </li>
   <li> Target "cleanR" then can just remove the build-directory. </li>
  </ul>


  \todo Documentation-page
  <ul>
   <li> Create a docus-documentation. </li>
