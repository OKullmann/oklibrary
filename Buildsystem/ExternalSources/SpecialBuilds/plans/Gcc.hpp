...
ExternalSources> oklib gcc gcc_user_options_okl="--with-system-zlib"
  ...
  \todo texi2dvi (texinfo 1.13a) fails to build gcc.texi on some systems
  <ul>
   <li> Texinfo versions 1.13a (from 2008) and below have a bug due to the
   formatting of strings passed to egrep. </li>
