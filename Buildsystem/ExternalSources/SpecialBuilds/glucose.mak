...
glucose : $(glucose_directories_okl)
	...
	CC="$(gcc_call_okl) $(zlib32_include_option_okl) $(zlib32_link_option_okl)" CXX="$(gpp_call_okl) $(zlib32_include_option_okl) $(zlib32_link_option_okl)" ./build.sh; $(postcondition) \
