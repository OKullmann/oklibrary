...
cryptominisat3_recommended_version_number_okl ?= 3.1
...
cryptominisat3_base_installation_dir_okl ?= $(ExternalSources_installations)/SAT/CryptoMinisat
...
cryptominisat3_exec_okl ?= cryptominisat
cryptominisat3_call_okl ?= $(cryptominisat3_installation_dir_okl)/$(cryptominisat3_recommended_okl)
