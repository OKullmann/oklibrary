...
public_link_list_okl ?= $(oksolver2002_okl) $(oksolver2002ntp_okl) $(oksolver2002outputxml_okl) $(oksolver2002_xml2maxima_okl) $(splitviaoksolver_okl) $(processsplitviaoksolver_okl) $(extracticnf_okl) $(extractminisat_okl) $(ucp_okl) $(ucpw_okl) $(rucpbase_okl) $(rucpgen_okl) $(randomrucpbases_okl) $(ramsey_generator_okl) $(vanderwaerden_generator_okl) $(lininequal_trans_okl) $(boundones_okl) $(vdwtransversals_okl) $(vdwtransversalspb_okl) $(vdwtransversalsinc_okl) $(vdwtransversalsincpb_okl) $(gttransversals_okl) $(gttransversalsinc_okl) $(oksolver_2002_m2pp_okl) $(satz215_m2pp_okl) $(extdimacs2dimacs_okl) $(extdimacsstatistics_okl) $(extdimacsfullstatistics_okl) $(sortbyclauselength_okl) $(randomshuffledimacs_okl) $(appenddimacs_okl) $(preprocesssplitting_okl) $(boundedtransversalsbv_okl) $(rankprimes_okl) $(grosswaldhagisformula_okl) $(greentao_okl) $(pdvanderwaerden_okl) $(countprogressionsgreentao_okl) $(pdextend_okl) $(solutionshift_okl) $(quinemccluskey_okl) $(quinemccluskeysubsumptionhypergraph_okl) $(quinemccluskeysubsumptionhypergraphwithfullstatistics_okl) $(quinemccluskeysubsumptionhypergraphfullstatistics_okl) $(vdw_minimumtransversals_okl) $(gt_minimumtransversals_okl) $(greentaocnf_okl) $(greentaogcnf_okl) $(greentaogen_okl) $(greentaodgen_okl) $(pdvanderwaerdencnf_okl) $(smusathorn_okl) $(musatd2_okl) $(oklib_call) $(runvdw3k_okl) $(runvdwk1k2_okl) $(runpdvdwk1k2_okl) $(crunpdvdwk1k2_okl) $(applypass_okl)  $(extractcertificatevdW2_okl) $(extractsolutionubcsat_okl) $(measurecpuspeed_okl) $(measurecpuspeedmem_okl)
