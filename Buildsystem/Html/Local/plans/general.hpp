...
/*!
  ...
  <ul>
   ...
   So perhaps if we want to use the logo, then we have to fix the
   background-colour? </li>
   <li> The colour of the scriptur is a bit too lavenderish (a touch of darker
   blue perhaps). </li>
   <li> Perhaps a tiny bit of space between "OK" and "library" (looks
   squeezed). </li>
   <li> Comments on how the logo has been created are needed: We need a kind
   of a "generic template" (at least a procedure). Gimp is a powerful tool;
   perhaps we can describe how to create the logo with Gimp? </li>
  </ul>
