...
%
%
% Bibliographie (7.3.2004)
%
\newcommand{\VolleBibliographie}{\bibliography{%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/EigArt,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/DP-SAT-Alg,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Resolution,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/UntereSchranken,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/complexity,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Logik,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Algebra,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/MiscSAT,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/polySAT,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Allg-SAT-Alg,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/SAT_Local_S,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Graphen,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/BDD,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Average-time,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Matroide,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/minUNSAT,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/LP,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/ArtInt,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/SAT-Experimente,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Kombinatorik,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Matrizen,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Kryptologie,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/RandomSAT,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Computer/Software,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Computer/Linux,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Computer/Latex,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Programmierung,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/zuBeschaffen,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Visualisierung,% 
  /h/21/GemeinsameBasis/Literatur/Bibliographie/BoolFunktionen,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Stochastik,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Topologie,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/Analysis,%
  /h/21/GemeinsameBasis/Literatur/Bibliographie/KombGeo,%
