...
/*!
  \file QuantumPhysics/plans/QuantumPhysics.hpp
  \brief Plans regarding certain aspects of quantum physics
  ...
  \todo Detailed examination of Peres33PointConfiguration.cnf
   ...
   - necessary and potentially necessary clauses etc. ({-1,-2,-3} is necessary, and also the
     ...
     from the "free pairs" are necessary --- so perhaps all 33 variables are needed)
