...
/* HAVE_DECL_* is a three-state macro: undefined, 0 or 1.  If it is
  ...
  extern char *basename PARAMS ((const char *)) throw(); // OK 19.2.2006
#else
...
/* Like sprintf but provides a pointer to malloc'd storage, which must
  ...
  extern int asprintf PARAMS ((char **, const char *, ...)) throw() ATTRIBUTE_PRINTF_2; // OK 19.2.2006
#endif
...
extern int vasprintf PARAMS ((char **, const char *, va_list)) throw()
