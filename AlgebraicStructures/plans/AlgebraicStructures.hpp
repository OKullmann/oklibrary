...
/*!
  ...
  SAT ? One would think of semirings (but associativity
  could be a stumbling block here), or structures related
  to finite geometries.

  Also in the context of universal algebra a lot of
...
/*!
  \namespace OKlib::AlgebraicStructures
  \brief Components related to the search for algebraic
  structures by means of (generalised) SAT
*/
