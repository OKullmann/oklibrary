...
/*!
  \file MonitoringExperiments.hpp
  ...
  to the (transitional) library. Necessary extensions (improvements):
   - Descriptors:
...
#ifndef MONITORINGEXPERIMENTS_kkdbbXX

#define MONITORINGEXPERIMENTS_kkdbbXX
