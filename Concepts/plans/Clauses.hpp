...
/*!
  ...
  quite right. An active clauses perhaps is something like
  ...
  It should be possible to easily switch between
  ...
  Regarding the operations considered above, from the concept-side (the operations and
  ...
  The CNF(DNF)-representation of some condition is just a representation of those assignments
  we realised as falsifying (satisfying).
*/
